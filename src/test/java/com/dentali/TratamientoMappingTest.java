...
public class TratamientoMappingTest {
    ...
    public void testJsonMapping() throws Exception {
        // Probamos con "doctor_id" y "paciente_id" (como está ahora tras la unificación)
        ...
        System.out.println("DTO (unified): idDoctor=" + dto.getIdDoctor() + ", idPaciente=" + dto.getIdPaciente() + ", idCita=" + dto.getIdCita());
